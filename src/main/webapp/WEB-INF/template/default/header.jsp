...
<header class="header">
	<spring:url value="/resources/img" var="img_url" />
						...
						<li>
							...
							<ul class="menu">
								<li>
									...
									<a href="#">
										<div class="pull-left">
											<img src="${img_url}/avatar3.png" class="img-circle" alt="User Image" />
										</div>
										<h4>
											Support Team
											<small>
								...
								<li>
									<a href="#">
										<div class="pull-left">
											<img src="${img_url}/avatar2.png" class="img-circle" alt="user image" />
										</div>
										<h4>
								...
								<li>
									<a href="#">
										<div class="pull-left">
											<img src="${img_url}/avatar.png" class="img-circle" alt="user image" />
										</div>
										<h4>
											Developers
											<small>
					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<ul class="menu">
								...
								<li>
									<a href="#">
										<i class="ion ion-ios7-person danger"></i>
